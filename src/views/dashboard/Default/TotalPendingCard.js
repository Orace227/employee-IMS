...
const CardWrapper = styled(MainCard)(({ theme }) => ({
  ...
  '&:before': {
    ...
    width: 210,
    height: 210,
    background: `linear-gradient(140.9deg, ${theme.palette.warning.light} -14.02%, rgba(144, 202, 249, 0) 77.58%)`,
    borderRadius: '50%',
    top: -160,
    right: -130
  }
...
const TotalPendingCard = ({ isLoading }) => {
  ...
  const getCancledOrders = async () => {
    ...
    const CanceledOrders = await axios.get(`/GetOrders?Status=pending&cartId=${cartId}`, {
